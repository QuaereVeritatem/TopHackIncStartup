...
class PersonData {
    ...
    var arrayPersonsOfInterest = [
        personsOfInterest(fullName: "Robert Martin", compName: "The company everyone loves", jobType: JobTypes.Developer, networkStatus: NetworkStatus.MightNeedThereHelp, standoutInfo: "Very Imaginative...and not Tom", poiEmail: "Use Slack", poiThumbnailPic: "Not Tom", linkedInUser: "", twitterUser: "", faceBookUser: "",instagramUser: "" )]
